...
export function MediaSection({ title, media, className }: MediaSectionProps) {
  if (media.length === 0) return null;
  return (
    <section className={cn("my-5 overflow-hidden", className)}>
      {" "}
      <Container>
        {" "}
      ...
      >
        ...
        <CarouselContent className="pr-5 pl-6 md:pr-7 lg:pr-9 lg:pl-10">
          ...
          <CarouselItem
            aria-hidden
            className="pointer-events-none basis-4"
          />{" "}
        </CarouselContent>{" "}
